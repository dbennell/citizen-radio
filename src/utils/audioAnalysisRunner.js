 ...
 * 
 * This script runs audio analysis on files in the specified directory for mood and energy metrics.
 * It can be run as a standalone utility or integrated with the main application.
 */

const path = require('path');
const fs = require('fs');
const AudioAnalysisEngine = require('./AudioAnalysisEngine');
...
async function analyzeDirectory(directory = DEFAULT_MUSIC_DIR, extensions = ['.mp3', '.wav', '.flac']) {
    ...
    const analyzer = new AudioAnalysisEngine();
